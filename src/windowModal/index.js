...
class WindowModal extends React.Component {
  ...
  handleOnNewsChange = () => {
    this.setState(prevState => ({
      ...
      form: {
        ...prevState.form,
        newsAccess: !prevState.form.newsAccess,
      },
    }));
  }
  ...
  render() {
    ...
    const newsLabel = (
      <span>I agree to my personal data being stored and used. 
        <a
          styleName="policy"
      ...
      >
        {isDone &&
          <div styleName="modalContainer success">
            <div styleName="modalTitle">Thank you for testing Storiqa's beta version!</div>

            <div styleName="modalDescription">Make sure you left your email and wallet address, we inform you later when tokens will be distibuted.</div>
            <div styleName="modalDescription">
              Join Telegram to get updates first!
              <a styleName="modalLink" href="https://t.me/storiqa_en"><Icon type="telegram" inline size={20} /> https://t.me/storiqa_en</a>
            </div>

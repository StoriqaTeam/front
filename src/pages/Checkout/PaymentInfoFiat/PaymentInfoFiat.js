...
// export default PaymentInfoFiat;

export default createRefetchContainer(
  withRouter(PaymentInfoFiat),
  graphql`
    fragment PaymentInfoFiat_me on User
  ...
  `,
  graphql`
    query PaymentInfoFiat_Query($id: String!) {
      me {
        ...PaymentInfoFiat_me @arguments(id: $id)
      }
    }
  `,
);

    ...
    <div styleName="container">
        ...
        <div styleName="wrapper">
          ...
          <div styleName="info-block">
            <div>
              ...
              committed to helping our sellers thrive. Our goal is to guarantee
              the quality of experience and goods, for both buyers and sellers.
            </div>
            <div>
      ...
      <div styleName="block-3">
        <div styleName="wrapper">
          ...
          <div styleName="subtitle">
            We deliver high quality services and support, including<br />marketing
          ...
          <div styleName="blocksWrapper">
            ...
            <div styleName="block">
              ...
              <div styleName="text">
                One of the most important aspects of running an online store is
                clear and quick communication with customers. We provide 24/7
                customer service and and online consultants in regional
                languages.
              </div>
            </div>
            <div styleName="block">
              ...
              <div styleName="text">
                We provide the marketing needed to boost sales, from newsletters
                and CPA networks to paid advertising and many more.
              </div>
            </div>
            <div styleName="block">
              <img
              ...
              <div styleName="text">
                ...
                others. These eliminate multiple bank transaction charges and
                long waits to receive payments.
              </div>
            </div>
            <div styleName="block">
              <img
              ...
              <div styleName="text">
                We offer an efficient, simple, and powerful set of sales tools
                with a clear interface and thorough follow-up, all to make your
                goods available globally.
              </div>
            </div>
            <div styleName="block">
              <img
              ...
              <div styleName="text">
                ...
                yourselves: creating a product cards, preparing promotional and
                marketing materials, processing orders, supporting sales.
              </div>
            </div>
          </div>
        </div>
        ...
        <div styleName="wrapper">
          ...
          <div styleName="blocks">
            <div styleName="block">
              ...
              <div styleName="text">
                Manage your store, sales, employees, warehouses in a convenient
                interface anywhere in the world. Get statistics and analytics
                online
              </div>
            </div>
            <div styleName="block">
        ...
        <div styleName="wrapper">
          ...
          <div styleName="items">
            <div styleName="itemBlock">
              ...
              <div styleName="planDesc">1 STQ = $0.03 per product per day</div>
            ...
            <div styleName="itemBlock">
              ...
              <div styleName="planDesc">2 STQ = $0.06 per product per day</div>
            ...
            <div styleName="itemBlock">
              ...
              <div styleName="planDesc">3 STQ = $0.09 per product per day</div>
          ...
          <div styleName="questions">
            <div styleName="question">
              ...
              <div styleName="text">
                ...
                (специалистов) участие в формировании модели развития. Не
